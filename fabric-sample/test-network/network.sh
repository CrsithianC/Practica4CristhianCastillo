...
function createChannel() {
  setGlobals 0 Fabricante
  peer channel create -o localhost:7050 -c mycannel -f ./channel-artifacts/mychannel.tx --outputBlock ./channel-artifacts/mychannel.block --tls --cafile "$ORDERER_CA"
  infoln "Joining Fabricante to channel..."
  peer channel join -b ./channel-artifacts/mychannel.block

  infoln "Joining peer0.transportista to the channel..."
  setGlobals 0 Transportista
  peer channel join -b ./channel-artifacts/mychannel.block

  infoln "Joining peer0.distribuidor to the channel..."
  setGlobals 0 Distribuidor
  peer channel join -b ./channel-artifacts/mychannel.block
